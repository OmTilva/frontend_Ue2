...
import OrganisationForm from "./pages/components/OrganisationForm";
import ViewOrganisation from "./pages/components/ViewOrganisation";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/dadmincat" element={<CategoryForm />}></Route>
      </Routes>
    </BrowserRouter>
  );
}
